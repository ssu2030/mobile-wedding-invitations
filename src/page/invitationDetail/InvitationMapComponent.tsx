        ...
        <div className={styles.mapDetailInfomationDescriptionItem}>
            <AccordionComponent
                ...
                children={
                    <div
                        className={
                            styles.mapDetailInfomationDescriptionItemExplain
                        }
                    >
        ...
        <div className={styles.mapDetailInfomationDescriptionItem}>
            <AccordionComponent
                ...
                children={
                    ...
                    >
                        장충단길 입구 하차 - 간선 402, 405 (광화문-장지동 방향),
                        142, 420, 407 <br />
                        남산예술원 하차 - 402, 405 (장지동-광화문 방향) 한강진역
                        하차 - 간선 110, 405 <br />
                        서울시 중부기술 교육원, 블루스퀘어 하차 - 간선 142-144,
                        402, 407 / 지선 6211
                        <br />
                    </div>
                }
            ...
            <AccordionComponent
                ...
                children={
                    ...
                    >
                        ...
                        <br />
                        삼거리(우회전) -다산로에서 U턴 -소월길(하얏트
                        방향)-남산맨션 바로 옆 남산예술원 웨딩홀 <br />
                    </div>
                }
            />
        </div>
    ...
    return (
        <div className={styles.mapWrapper}>
            <div className={styles.titleWrapper}>
                {"* 오시는 길 *"}
                <div className={styles.namedivsion} />
            </div>
                    ...
                    <AccordionComponent
                        ...
                        children={
                            <div className={styles.mapDetailWrapper}>
                                ...
                                <div
                                    className={
                                        styles.detailInformationMapWithMapDetail
                                    }
                                >
